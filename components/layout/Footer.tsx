...
const Footer = ({ whatsappNumber = '5215648714631' }: { whatsappNumber?: string }) => {
            ...
            <div className="wholesale-banner">
                <div className="wholesale-content">
                    <div className="wholesale-text">
                        <h3>¿Interesado en comprar por mayoreo?</h3>
                        <p>Contáctanos para precios especiales y atención personalizada</p>
                    </div>
                    <a
                        href={`https://wa.me/${whatsappNumber}?text=Hola,%20me%20interesa%20información%20sobre%20ventas%20por%20mayoreo`}
                        target="_blank"
                ...
                <div className="footer-container">
                    ...
                    <div className="footer-brand">
                        ...
                        <div className="footer-social">
                            <a href="https://www.facebook.com/deliciasdelcampomx" target="_blank" rel="noopener noreferrer" aria-label="Facebook">
                                <svg viewBox="0 0 24 24" fill="currentColor">
                                    <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" />
                                </svg>
                            </a>
                            <a href="https://www.instagram.com/lasdeliciasdelcampomexico/" target="_blank" rel="noopener noreferrer" aria-label="Instagram">
                                <svg viewBox="0 0 24 24" fill="currentColor">
                            ...
                            <a href="https://www.tiktok.com/@las.delicias.delcampo" target="_blank" rel="noopener noreferrer" aria-label="TikTok">
                                <svg viewBox="0 0 24 24" fill="currentColor">
                    ...
                    <div className="footer-contact">
                        <h4>Contacto</h4>
                        <a
                            href={`https://wa.me/${whatsappNumber}?text=Hola,%20me%20gustaría%20pedir%20informes`}
                            target="_blank"
                            rel="noopener noreferrer"
